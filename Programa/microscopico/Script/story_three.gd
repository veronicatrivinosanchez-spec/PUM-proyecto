...
@onready var mitocondria_animated_sprite = $Mitocondria
@onready var centriolo_animated_sprite = $centriolo
...
var current_story_key: String = "" 

# --- Diccionario de Diálogo ---
var story_dialogue: Dictionary = {
	"inicio": [
		{ "speaker": "Centriolo", "text": "¡Cuidado! Estoy organizando para la división celular." },
		{ "speaker": "Mitocondria", "text": "¡Hola! Yo produzco la energía, el ATP." },
		{ "speaker": "Oliver", "text": "¡Entonces tú eres como una batería!" },
		{ "speaker": "Centriolo", "text": "Y yo mantengo el orden durante la división." },
		{ "speaker": "Oliver", "text": "¿Saben algo del peroxisoma?" },
		{ "speaker": "Mitocondria", "text": "Sí, entró al núcleo y desató el caos." },
		{ "speaker": "Oliver", "text": "Entonces debo ir allá." },
		{ "speaker": "Centriolo", "text": "Ve con cuidado, con el temblor se liberaron partes de ADN y bacterias." }
	]
}
...
func _ready() -> void:
	...
	if e_button_anim:
		e_button_anim.hide()
	if mitocondria_animated_sprite:
		mitocondria_animated_sprite.play("idle")
	if centriolo_animated_sprite:
		centriolo_animated_sprite.play("idle")
	if player:
...
func end_dialogue() -> void:
	...
	# Al terminar el diálogo va directo a FONDO
